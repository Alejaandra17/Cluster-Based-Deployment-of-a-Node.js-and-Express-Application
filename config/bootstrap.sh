...
DOMAIN="test.dns"        # Practice domain

ZONE_FILE="/var/lib/bind/ale.test.dns"
REV_ZONE_FILE="/var/lib/bind/ale.test.rev"
...
cp /vagrant/config/ale.test.dns $ZONE_FILE
cp /vagrant/config/ale.test.rev $REV_ZONE_FILE
